...
const SignIn = () => {
    return (
        <div><div className="h-full bg-gradient-to-tl from-blue-400 to-indigo-900 w-full py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div>
                        <lable className="text-sm font-medium leading-none text-gray-800">Email/Phone</lable>
                        <input aria-label="enter email address or phone number" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    </div>
